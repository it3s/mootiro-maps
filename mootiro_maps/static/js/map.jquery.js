    ...
    methods = {
      init: function(options) {
        return this.each(function() {
          var $this, map, opts, _ref, _ref1, _ref2;
          $this = $(this);
          ...
          if ((opts != null ? opts.type : void 0) === 'preview' && (((_ref = opts.geojson) != null ? _ref.features.length : void 0) === 0 || (((_ref1 = opts.geojson) != null ? _ref1.features.length : void 0) === 1 && !((_ref2 = opts.geojson.features[0]) != null ? _ref2.geometry : void 0))) && !(opts != null ? opts.force : void 0)) {
          ...
          if (opts.project != null) {
            return map.setProjectId(opts.project);
          }
        });
      },
      ...
      geojson: function(geojson) {
        ...
        if (!(geojson != null)) {
          ...
          return (_ref1 = $(this).data('map')) != null ? _ref1.loadGeoJson(geojson) : void 0;
        }
      },
      goTo: function(opts) {
        var _ref, _ref1;
        if ((_ref = $(this).data('map')) != null) {
          _ref.panTo((_ref1 = opts.position) != null ? _ref1 : opts.address, opts.displayMarker);
        }
        return $(this);
      },
