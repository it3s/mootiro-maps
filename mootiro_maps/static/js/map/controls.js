...
define(function(require) {
  ...
  Box = (function(_super) {
    ...
    Box.prototype.init = function() {
      ...
      this.box = (_ref2 = this.$el) != null ? _ref2 : $("<div>");
      if (this.id != null) {
  ...
  LoadingBox = (function(_super) {
    ...
    function LoadingBox() {
      return LoadingBox.__super__.constructor.apply(this, arguments);
    }
  ...
  LayersBox = (function(_super) {
    ...
    function LayersBox() {
      return LayersBox.__super__.constructor.apply(this, arguments);
    }
  ...
  SupporterBox = (function(_super) {
    ...
    function SupporterBox() {
      return SupporterBox.__super__.constructor.apply(this, arguments);
    }
  ...
  LicenseBox = (function(_super) {
    ...
    function LicenseBox() {
      return LicenseBox.__super__.constructor.apply(this, arguments);
    }
  ...
  DrawingManager = (function(_super) {
    ...
    function DrawingManager() {
      return DrawingManager.__super__.constructor.apply(this, arguments);
    }
    ...
    DrawingManager.prototype.init = function(options) {
      ...
      if ((_ref2 = (_base1 = this.options).drawingManagerOptions) == null) {
        _base1.drawingManagerOptions = this.defaultDrawingManagerOptions;
      }
      if (this.options.map) {
        return this.setMap(this.options.map);
      }
    };

    DrawingManager.prototype.initManager = function(options) {
      if (options == null) {
        options = this.defaultDrawingManagerOptions;
      }
    ...
    DrawingManager.prototype.setMode = function(mode) {
      var _ref2;
      this.mode = mode;
      this.manager.setDrawingMode(((_ref2 = this.mode) === ADD || _ref2 === NEW) || (this.mode === CUTOUT && this.feature.getGeometryType() === POLYGON) ? OVERLAY[this.feature.getGeometryType()] : null);
    ...
    DrawingManager.prototype.handleManagerEvents = function() {
      ...
      return komoo.event.addListener(this.manager, 'overlaycomplete', function(e) {
        var orientation, orientationAdded, path, paths, sArea, sAreaAdded, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
        path = (_ref2 = e.overlay) != null ? typeof _ref2.getPath === "function" ? _ref2.getPath() : void 0 : void 0;
        if (path && ((_ref3 = _this.mode) === ADD || _ref3 === NEW || _ref3 === CUTOUT) && ((_ref4 = e.overlay) != null ? _ref4.getPaths : void 0)) {
          ...
          if ((paths != null ? paths.length : void 0) > 0) {
            ...
            if ((orientation === orientationAdded && _this.mode === CUTOUT) || (orientation !== orientationAdded && ((_ref5 = _this.mode) === ADD || _ref5 === NEW))) {
        ...
        } else if (((_ref6 = _this.mode) === ADD || _ref6 === NEW) && e.overlay.getPosition) {
          _this.feature.getGeometry().addMarker(e.overlay);
          _this.feature.updateIcon(100);
        } else if (((_ref7 = _this.mode) === ADD || _ref7 === NEW) && e.overlay.getPath) {
          _this.feature.getGeometry().addPolyline(e.overlay, true);
        }
        _this.map.setMode(EDIT);
        return (_ref8 = _this.feature) != null ? _ref8.setEditable(true) : void 0;
      });
    };
  ...
  CloseBox = (function(_super) {
    ...
    function CloseBox() {
      return CloseBox.__super__.constructor.apply(this, arguments);
    }
    ...
    CloseBox.prototype.init = function(opt) {
      ...
      title = (_ref2 = opt.title) != null ? _ref2 : '';
  ...
  GeometrySelector = (function(_super) {
    ...
    function GeometrySelector() {
      return GeometrySelector.__super__.constructor.apply(this, arguments);
    }
    ...
    GeometrySelector.prototype.showContent = function() {
      var geometryType, _i, _len, _ref2, _ref3, _results;
      this.box.find('li').hide();
      _ref3 = (_ref2 = this.feature.getFeatureType()) != null ? _ref2.geometryTypes : void 0;
      _results = [];
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        geometryType = _ref3[_i];
  ...
  DrawingControl = (function(_super) {
    ...
    function DrawingControl() {
      return DrawingControl.__super__.constructor.apply(this, arguments);
    }
    ...
    DrawingControl.prototype.handleBoxEvents = function() {
      ...
      $("#drawing-control-finish", this.box).click(function() {
        if ($("#drawing-control-finish", _this.box).hasClass('disabled')) {
          return;
        }
    ...
    DrawingControl.prototype.setMode = function(mode) {
      ...
      return $("#drawing-control-" + ((_ref2 = this.mode) != null ? _ref2.toLowerCase() : void 0), this.box).addClass("active");
    };

    DrawingControl.prototype.getTitle = function() {
      var geometry, title, _ref2, _ref3;
      if (this.feature.getGeometryType() === POLYGON) {
        geometry = 'polygon';
        title = _ADD_SHAPE;
      } else if ((_ref2 = this.feature.getGeometryType()) === LINESTRING || _ref2 === MULTILINESTRING) {
        geometry = 'linestring';
        title = _ADD_LINE;
      } else if ((_ref3 = this.feature.getGeometryType()) === POINT || _ref3 === MULTIPOINT) {
        geometry = 'point';
        title = _ADD_POINT;
      }
    ...
    DrawingControl.prototype.getContent = function() {
      ...
      if (this.feature.getGeometryType() !== POINT) {
        content.append(add);
      }
      if (this.feature.getGeometryType() === POLYGON) {
  ...
  PerimeterSelector = (function(_super) {
    ...
    function PerimeterSelector() {
      return PerimeterSelector.__super__.constructor.apply(this, arguments);
    }
  ...
  Balloon = (function(_super) {
    ...
    Balloon.prototype.open = function(options) {
      var empty, newPosition, point, position, _ref2, _ref3, _ref4, _ref5;
      this.options = options != null ? options : {};
      if (!this.enabled) {
        return;
      }
      ...
      this.feature = (_ref2 = this.options.feature) != null ? _ref2 : (_ref3 = this.options.features) != null ? _ref3.getAt(0) : void 0;
      position = (_ref4 = this.options.position) != null ? _ref4 : this.feature.getCenter();
      ...
      return this.infoBox.open((_ref5 = this.map.googleMap) != null ? _ref5 : this.map);
    };
    ...
    Balloon.prototype.close = function() {
      ...
      this.infoBox.close();
      if ((_ref2 = this.feature) != null ? _ref2.isHighlighted() : void 0) {
  ...
  AjaxBalloon = (function(_super) {
    ...
    function AjaxBalloon() {
      return AjaxBalloon.__super__.constructor.apply(this, arguments);
    }
    ...
    AjaxBalloon.prototype.createFeatureContent = function(options) {
      ...
      if (feature[this.contentViewName]) {
        return feature[this.contentViewName];
      }
  ...
  InfoWindow = (function(_super) {
    ...
    InfoWindow.prototype.open = function(options) {
      var _ref2, _ref3;
      if ((_ref2 = this.feature) != null) {
        _ref2.displayTooltip = true;
      }
      InfoWindow.__super__.open.call(this, options);
      return (_ref3 = this.feature) != null ? _ref3.displayTooltip = false : void 0;
    };
    ...
    InfoWindow.prototype.close = function(enableTooltip) {
      ...
      if ((_ref2 = this.feature) != null) {
        _ref2.setHighlight(false);
      }
      if ((_ref3 = this.feature) != null) {
        _ref3.displayTooltip = true;
      }
      if (enableTooltip) {
  ...
  Tooltip = (function(_super) {
    ...
    Tooltip.prototype.handleMapEvents = function() {
      ...
      this.map.subscribe('cluster_mouseover', function(features, position) {
        var _ref2;
        if (!((_ref2 = features.getAt(0)) != null ? _ref2.displayTooltip : void 0)) {
          return;
        }
        return _this.open({
          features: features,
  ...
  FeatureClusterer = (function(_super) {
    ...
    function FeatureClusterer() {
      return FeatureClusterer.__super__.constructor.apply(this, arguments);
    }
    ...
    FeatureClusterer.prototype.init = function(options) {
      var _base1, _base2, _base3, _base4, _base5, _ref2, _ref3, _ref4, _ref5, _ref6;
      this.options = options != null ? options : {};
      if ((_ref2 = (_base1 = this.options).gridSize) == null) {
        _base1.gridSize = this.gridSize;
      }
      if ((_ref3 = (_base2 = this.options).maxZoom) == null) {
        _base2.maxZoom = this.maxZoom;
      }
      if ((_ref4 = (_base3 = this.options).minimumClusterSize) == null) {
        _base3.minimumClusterSize = this.minSize;
      }
      if ((_ref5 = (_base4 = this.options).imagePath) == null) {
        _base4.imagePath = this.imagePath;
      }
      if ((_ref6 = (_base5 = this.options).imageSizes) == null) {
        _base5.imageSizes = this.imageSizes;
      }
    ...
    FeatureClusterer.prototype.initMarkerClusterer = function(options) {
      ...
      map = ((_ref2 = this.map) != null ? _ref2.googleMap : void 0) || this.map;
    ...
    FeatureClusterer.prototype.handleMapEvents = function() {
      ...
      this.map.subscribe('idle features_loaded', function() {
        if (_this.map.getZoom() <= _this.maxZoom) {
          if (_this.length === 0) {
            _this.addFeatures(_this.map.getFeatures());
          }
          return _this.repaint();
        }
      });
      ...
      return komoo.event.addListener(this, 'clusteringend', function(mc) {
        if (_this.map.getZoom() > _this.maxZoom) {
          return _this.map.features.forEach(function(feature) {
            var _ref2;
            return (_ref2 = feature.marker) != null ? _ref2.setMap(null) : void 0;
          });
        }
      });
    };
    ...
    FeatureClusterer.prototype.forEach = function(callback, thisArg) {
      var feature, _i, _len, _ref2, _results;
      _ref2 = this.features;
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        feature = _ref2[_i];
  ...
  CommunityClusterer = (function(_super) {
    ...
    function CommunityClusterer() {
      return CommunityClusterer.__super__.constructor.apply(this, arguments);
    }
  ...
  SaveLocation = (function(_super) {
    ...
    function SaveLocation() {
      return SaveLocation.__super__.constructor.apply(this, arguments);
    }
  ...
  AutosaveLocation = (function(_super) {
    ...
    function AutosaveLocation() {
      return AutosaveLocation.__super__.constructor.apply(this, arguments);
    }
  ...
  SaveMapType = (function(_super) {
    ...
    function SaveMapType() {
      return SaveMapType.__super__.constructor.apply(this, arguments);
    }
  ...
  AutosaveMapType = (function(_super) {
    ...
    function AutosaveMapType() {
      return AutosaveMapType.__super__.constructor.apply(this, arguments);
    }
  ...
  StreetView = (function(_super) {
    ...
    function StreetView() {
      return StreetView.__super__.constructor.apply(this, arguments);
    }
    ...
    StreetView.prototype.createObject = function() {
      ...
      if ((_ref2 = this.map) != null) {
        _ref2.googleMap.setStreetView(this.streetView);
      }
  ...
  FeatureFilter = (function(_super) {
    ...
    function FeatureFilter() {
      return FeatureFilter.__super__.constructor.apply(this, arguments);
    }
  ...
  FeatureZoomFilter = (function(_super) {
    ...
    function FeatureZoomFilter() {
      return FeatureZoomFilter.__super__.constructor.apply(this, arguments);
    }
  ...
  FeatureTypeFilter = (function(_super) {
    ...
    function FeatureTypeFilter() {
      return FeatureTypeFilter.__super__.constructor.apply(this, arguments);
    }
    ...
    FeatureTypeFilter.prototype.beforeFeatureSetVisibleHook = function(feature, visible) {
      var visible_, _ref2;
      visible_ = visible;
      if (visible && (_ref2 = feature.featureType.type, __indexOf.call(this.disabled, _ref2) >= 0)) {
        visible_ = false;
      }
      return [feature, visible_];
    };
  ...
  LayersFilter = (function(_super) {
    ...
    function LayersFilter() {
      return LayersFilter.__super__.constructor.apply(this, arguments);
    }
