...
define(function(require) {
  'use strict';
  var FeatureCollection, FeatureCollectionPlus, GenericCollection, googleMaps, _base;
  ...
  GenericCollection = (function() {
    ...
    GenericCollection.prototype.remove = function() {
      ...
      for (_i = 0, _len = args.length; _i < _len; _i++) {
        ...
        if (index !== -1) output.push(this.elements.splice(index, 1));
      }
  ...
  FeatureCollectionPlus = (function(_super) {
    ...
    FeatureCollectionPlus.prototype.push = function(feature) {
      var type, _base2, _base3, _base4, _base5, _base6, _base7, _base8, _ref,
        _this = this;
      ...
      if ((_base7 = this.featuresByType)['all'] == null) _base7['all'] = {};
      if ((_base8 = this.featuresByType['all'])['ids'] == null) _base8['ids'] = {};
    ...
    FeatureCollectionPlus.prototype.highlightFeature = function(type, id) {
      var feature, _ref, _ref2;
      feature = (_ref = typeof type) === 'string' || _ref === 'number' ? this.getById(type, id) : type;
      if (feature.isHighlighted()) return;
      if ((_ref2 = this.highlighted) != null) _ref2.setHighlight(false);
      feature.highlight();
