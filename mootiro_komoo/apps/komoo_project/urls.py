...
urlpatterns = patterns('komoo_project.views',
    ...
    url(r'^project/delete_relations/?$', 'delete_relations',
    ...
    url(pr(r'^project/ID/?$'), 'project_view', name='project_view'),

    url(pr(r'^project/ID/edit/?$'), 'project_edit', name='project_edit'),

    url(pr(r'project/ID/map/?$'), 'project_map', name='project_map'),
)
