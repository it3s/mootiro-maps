...
urlpatterns = patterns('organization.views',
    ...
    url(r'^organizations/?$', 'organizations_to_organization',
                name='deprecated_organization_list'),
    ...
    url(pr(r'^organization/ORGANIZATION_SLUG/edit/?$'), 'edit_organization',
                name='edit_organization'),
    url(pr(r'^organization/ORGANIZATION_SLUG/related/?$'), 'related_items',
